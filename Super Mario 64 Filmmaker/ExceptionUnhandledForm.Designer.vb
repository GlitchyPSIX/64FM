...
Partial Class ExceptionUnhandledForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "64Filmmaker BETA has been closed due to an unhandled exception. You have been dis" &
    "connected from the chat and all other windows have been closed."
        '
        'btnRestart
        '
