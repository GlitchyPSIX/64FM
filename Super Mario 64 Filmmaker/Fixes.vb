Public Class Fixes
    ...
    Public Shared Sub NoGhosts(ByVal Restart As Boolean, ByVal Forced As Boolean)
            ...
            If Restart = True Then
                ...
                If Question = DialogResult.Yes Then
                    For Each p As Process In Process.GetProcessesByName("project64")
                        p.Kill()
                    Next
                    MainMenu.EMUProcess = Process.Start(Application.StartupPath & "\Core\Emu\Project64.exe", Chr(34) & Application.StartupPath & "\Core\ROM\SM64_NORMAL_WS.z64" + Chr(34))
                End If
            Else
